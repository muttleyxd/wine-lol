...
#define IOCTL_AFD_UNK1  CTL_CODE(FILE_DEVICE_BEEP, 0x801, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_AFD_UNK3  CTL_CODE(FILE_DEVICE_BEEP, 0x803, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_AFD_UNK4  CTL_CODE(FILE_DEVICE_BEEP, 0x804, METHOD_BUFFERED, FILE_ANY_ACCESS)
// 805 is RECV
#define IOCTL_AFD_UNK6  CTL_CODE(FILE_DEVICE_BEEP, 0x806, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_AFD_UNK7  CTL_CODE(FILE_DEVICE_BEEP, 0x807, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_AFD_UNK8  CTL_CODE(FILE_DEVICE_BEEP, 0x808, METHOD_NEITHER, FILE_ANY_ACCESS)
// 809 is SELECT
#define IOCTL_AFD_UNKA  CTL_CODE(FILE_DEVICE_BEEP, 0x80a, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_AFD_UNKB  CTL_CODE(FILE_DEVICE_BEEP, 0x80b, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_AFD_UNKC  CTL_CODE(FILE_DEVICE_BEEP, 0x80c, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_AFD_UNKD  CTL_CODE(FILE_DEVICE_BEEP, 0x80d, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_AFD_UNKE  CTL_CODE(FILE_DEVICE_BEEP, 0x80e, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_AFD_UNKF  CTL_CODE(FILE_DEVICE_BEEP, 0x80f, METHOD_NEITHER, FILE_ANY_ACCESS)

#define AFD_SELECT_RDNORM   0x0001
#define AFD_SELECT_RDBAND   0x0002
#define AFD_SELECT_WRNORM   0x0004
#define AFD_SELECT_HUP      0x0008
#define AFD_SELECT_RESET    0x0010
#define AFD_SELECT_CLOSE    0x0020
#define AFD_SELECT_WRBAND   0x0040
#define AFD_SELECT_ACCEPT   0x0080
#define AFD_SELECT_ERR      0x0100

#include "pshpack4.h"
struct afd_select_params
{
    LONGLONG timeout;
    unsigned int count;
    BOOLEAN unknown;
...
#define IOCTL_AFD_SELECT    CTL_CODE(FILE_DEVICE_BEEP, 0x809, METHOD_BUFFERED, FILE_ANY_ACCESS)
